...
class ControllerExtensionPaymentIcepayBasic extends Controller
{
	...
	public function index() {
		...
		$data['icepay_ajax_get'] = $base_url . 'index.php?route=extension/payment/icepay_basic/getMyPaymentMethods';
		$data['icepay_ajax_save'] = $base_url . 'index.php?route=extension/payment/icepay_basic/saveMyPaymentMethods';
